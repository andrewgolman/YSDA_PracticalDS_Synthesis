...
class FastSpeech2Loss(nn.Module):
    ...
    def forward(
        ...
        p_value_predicted = p_predicted
        p_value_target = p_target
        p_value_predicted = p_value_predicted.masked_select(mel_mask)
        p_value_target = p_value_target.masked_select(mel_mask)
        ...
        p_loss = self.mse_loss(p_value_predicted, p_value_target)
